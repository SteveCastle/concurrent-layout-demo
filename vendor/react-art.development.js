...
function updatePureComponent(current, workInProgress, Component, nextProps, updateExpirationTime, renderExpirationTime) {
  var render = Component.render;

  if (current !== null && (updateExpirationTime === NoWork || updateExpirationTime > renderExpirationTime)) {
...
function mountIndeterminateComponent(current, workInProgress, Component, updateExpirationTime, renderExpirationTime) {
  ...
  if (typeof Component === 'object' && Component !== null && typeof Component.then === 'function') {
    ...
    switch (resolvedTag) {
      case FunctionComponentLazy:
        {
          child = updateFunctionComponent(current, workInProgress, Component, resolvedProps, renderExpirationTime);
          break;
        }
      case ClassComponentLazy:
        {
          child = updateClassComponent(current, workInProgress, Component, resolvedProps, renderExpirationTime);
          break;
        }
      case ForwardRefLazy:
        {
          child = updateForwardRef(current, workInProgress, Component, resolvedProps, renderExpirationTime);
          break;
        }
      case PureComponentLazy:
        {
          child = updatePureComponent(current, workInProgress, Component, resolvedProps, updateExpirationTime, renderExpirationTime);
          break;
        }
      default:
        {
    ...
    case IndeterminateComponent:
      {
        ...
        return mountIndeterminateComponent(current, workInProgress, _Component2, updateExpirationTime, renderExpirationTime);
      }
    case FunctionComponent:
      {
        var _Component3 = workInProgress.type;
        var unresolvedProps = workInProgress.pendingProps;
        return updateFunctionComponent(current, workInProgress, _Component3, unresolvedProps, renderExpirationTime);
      }
    case FunctionComponentLazy:
      {
        ...
        var child = updateFunctionComponent(current, workInProgress, _Component4, resolveDefaultProps(_Component4, _unresolvedProps), renderExpirationTime);
    ...
    case ClassComponent:
      {
        ...
        return updateClassComponent(current, workInProgress, _Component5, _unresolvedProps2, renderExpirationTime);
      }
    case ClassComponentLazy:
      {
        ...
        var _child = updateClassComponent(current, workInProgress, _Component6, resolveDefaultProps(_Component6, _unresolvedProps3), renderExpirationTime);
    ...
    case ForwardRefLazy:
      {
        ...
        var _child2 = updateForwardRef(current, workInProgress, _Component7, resolveDefaultProps(_Component7, _unresolvedProps4), renderExpirationTime);
    ...
    case PureComponent:
      {
        ...
        return updatePureComponent(current, workInProgress, _type, workInProgress.pendingProps, updateExpirationTime, renderExpirationTime);
      }
    case PureComponentLazy:
      {
        ...
        var _child3 = updatePureComponent(current, workInProgress, _Component8, resolveDefaultProps(_Component8, _unresolvedProps5), updateExpirationTime, renderExpirationTime);
